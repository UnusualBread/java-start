package com.unusualbread.app.theory.M04_errorless_code.S01_exception_handling.L03_exception_handling;
...
Your task is to implement the second method. It must call the first method and
catch two types of exceptions:
    - ArrayIndexOutOfBoundsException
    - NumberFormatException
Inside the catch block (or blocks) you should print the name of the handled
exception class (only name, without packages) to the standard output.
*/

import java.util.*;

public class T02_ExceptionsCatcher {
